...
if __name__ == '__main__':
    ...
    students_by_name_desc = [student for student in session.query(
            Student.name, Student.grade).order_by(
            desc(Student.grade))]

    print(students_by_name_desc)

    oldest_student = [student for student in session.query(
            Student.name, Student.birthday).order_by(desc(
            Student.name)).first()]

    print(oldest_student)

    number_of_student = session.query(func.count(Student.grade)).first()
